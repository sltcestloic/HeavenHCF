...
public class Crowbar
{
	...
	public Optional<ItemStack> toItemStack() {
        if (this.needsMetaUpdate) {
            ...
            meta.setLore((List)Arrays.asList(String.format(Crowbar.LORE_FORMAT, "Spawner Uses", this.spawnerUses, 1), String.format(Crowbar.LORE_FORMAT, "End Frame Uses", this.endFrameUses, 5)));
